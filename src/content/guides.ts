    ...
    steps: [
      {
        ...
        text: "Two changes do most of the work here. Smaller meals put less pressure on the valve at the top of the stomach, so three modest meals sit better than one large one. And leave three hours between your last meal and lying down, which usually means moving dinner earlier rather than eating less at it.",
        topicSlug: "nutrition-basics",
        topicLabel: "Nutrition basics",
      },
      {
        ...
        text: "Gravity is doing useful work while you are upright. Avoid lying down or reclining for a couple of hours after a meal, and skip the after-dinner nap. A gentle walk instead helps digestion and is worth doing for several other reasons besides.",
        topicSlug: "movement-and-blood-sugar",
        topicLabel: "Movement & blood sugar",
      },
      {
