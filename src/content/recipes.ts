...
export const recipes: Recipe[] = [
  ...
  },
  {
    ...
    category: "Food & energy",
    summary:
      "Steamed gram flour dumplings in a curd gravy. One of the highest protein vegetarian dishes in Indian cooking.",
    keyPoints: [
      "Gram flour and curd together make this genuinely high in protein.",
    ...
    prepTimeIso: "PT35M",
    intro: [
      "Rajasthani cooking worked out long ago how to eat well without vegetables, and gatte is the best example. Gram flour dumplings in a curd gravy, and between the besan and the curd it carries more protein than most vegetarian mains.",
    ...
    notes: [
      ...
      "A portion with one roti and a salad is a complete meal with no other protein needed.",
    ],
    relatedTopics: [
      "muscle-as-your-bodys-engine",
      "nutrition-basics",
  ...
  },
  {
    ...
    category: "Food & energy",
    summary:
      "Soya chunks carry more protein per gram than almost anything else in an Indian kitchen.",
    keyPoints: [
      "Soya chunks are exceptionally high in protein, more than paneer by weight.",
    ...
    prepTimeIso: "PT25M",
    intro: [
      "Soya chunks, sold as nutri or nutrela, are the cheapest concentrated protein most Indian kitchens have access to, and they sit in the cupboard for months. Weight for weight they beat paneer comfortably.",
